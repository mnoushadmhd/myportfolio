...
const Home = () => {
  return (
   <div>
    <div className='lg:mt-10 md:mt-7 sm:mt-5 flex flex-col items-start justify-center gap-2 '>
      <h1 className="lg:text-6xl md:4xl; sm:text-3xl dark:text-neutral-100"><span className="text-red-500 ">Noushad</span> M</h1>
      <p className="leading-7 text-normal text-neutral-800 dark:text-neutral-400">Web Developer.</p>
    </div>
    <section className='mt-10'>
      <div className='flex flex-col items-start justify-start gap-3 p-0 bg-transparent rounded-lg sm:p-10 sm:bg-indigo-50 dark:sm:bg-neutral-900'>
        <p className='leading-7 text-normal text-neutral-800 dark:text-neutral-400'>Hi, I'm Noushad M from Kerala, IN & I love to code⚡ and Design 🎨.</p>
        <p className='leading-7 text-normal text-neutral-800 dark:text-neutral-400'>
        ...
        <p className='leading-7 text-normal text-neutral-800 dark:text-neutral-400'>
          Intend to build a career with committed &amp; dedicated people, which will help me to contribute in creating exceptional user experience.
        </p>
        <hr className='w-full my-3 border-indigo-200 dark:border-neutral-800'/>
        <div className='flex flex-row items-start justify-start gap-3 p-0 bg-transparent rounded-lg  sm:bg-indigo-50 dark:sm:bg-neutral-900'>
